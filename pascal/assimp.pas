...
type
  ...
  aiAnimMesh = record
    mName: aiString;
    mVertices, mNormals, mTangents, mBitangents: PaiVector3D;
  ...
  aiMesh = record
    ...
    mAnimMeshes: ^PaiAnimMesh;
    mMethod: aiMorphingMethod;
    mAABB: aiAABB;
    mTextureCoordsNames: ^PaiString;
  end;
  ...
  aiMaterial = record
    mProperties: PaiMaterialProperty;
  ...
  aiAnimation = record
    ...
    mChannels: PaiNodeAnim;
    mNumMeshChannels: Cardinal;
    mMeshChannels: PaiMeshAnim;
    mNumMorphMeshChannels: Cardinal;
    mMorphMeshChannels: PaiMeshMorphAnim;
  end;
  ...
  aiScene = record
    ...
    mMaterials: PaiMaterial;
    mNumAnimations: Cardinal;
    mAnimations: PaiAnimation;
    mNumTextures: Cardinal;
    mTextures: PaiTexture;
    mNumLights: Cardinal;
    mLights: PaiLight;
...
function aiImportFile(pFile: PChar; pFlags: Cardinal): PaiScene; cdecl; external;
...
function aiGetEmbeddedTexture(const pIn: PaiScene; filename: PChar): PaiTexture; cdecl; external;
