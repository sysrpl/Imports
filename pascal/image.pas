...
(* C implementation listing, uses https://github.com/nothings/stb
...
unsigned char* load_image_from_memory(const unsigned char *buffer, int len, int *width, int *height) {
	int channels;
...
void save_image(const void *image, int width, int height, int kind, const char *filename) {
	switch (kind) {
		case 0:
...
void save_image_callback(const void *image, int width, int height, int kind, stbi_write_func *callback, void *userdata) {
	switch (kind) {
		case 0:
